...
import { CheckCircle, Calendar, Clock, Users, MapPin, Phone, Mail } from 'lucide-react';
...
const BookingConfirmation = () => {
  ...
  const paymentId = location.state?.paymentId;   // ✅ NEW LINE
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center">
                    <div className="h-5 w-5 mr-3 flex items-center justify-center">🏨</div>
                    <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">{booking.nights} night(s)</div>
                    </div>
                  </div>
        ...
        <div className="bg-blue-50 rounded-lg p-6 mb-8">
          ...
          <ul className="space-y-2 text-blue-800">
            ...
            <li>• Contact the hotel for any special requests</li>
          </ul>
        </div>

        {/* Actions */}
        <div className="text-center">
          <button onClick={handleNewBooking} className="btn-primary mr-4">
